...
@section('content')
    ...
    <div class="page-inner">
        ...
        <div>
            ...
            <h6 class="op-7 mb-2">Dashboard content</h6>
            </div>
                    ...
                    <div class="table-responsive table-hover table-sales">
                        ...
                        <tbody>
                            ...
                            <td>
                                <div class="flag">
                                <img
                                    src="{{ asset('assets/cms/img/flags/id.png') }}"
                                    alt="indonesia"
                                />
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="flag">
                                <img
                                    src="{{ asset('assets/cms/img/flags/us.png') }}"
                                    alt="united states"
                                />
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="flag">
                                <img
                                    src="{{ asset('assets/cms/img/flags/au.png') }}"
                                    alt="australia"
                                />
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="flag">
                                <img
                                    src="{{ asset('assets/cms/img/flags/ru.png') }}"
                                    alt="russia"
                                />
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="flag">
                                <img
                                    src="{{ asset('assets/cms/img/flags/cn.png') }}"
                                    alt="china"
                                />
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="flag">
                                <img
                                    src="{{ asset('assets/cms/img/flags/br.png') }}"
                                    alt="brazil"
                                />
                                </div>
                            </td>
        ...
        <div class="row">
            ...
            <div class="card card-round">
                ...
                <div class="card-list py-4">
                    ...
                    <div class="avatar">
                        <img
                        src="{{ asset('assets/cms/img/jm_denis.jpg') }}"
                        alt="..."
                    ...
                    <div class="avatar">
                        <img
                        src="{{ asset('assets/cms/img/talha.jpg') }}"
                        alt="..."
                        class="avatar-img rounded-circle"
                        />
                    </div>
                    ...
                    <div class="avatar">
                        <img
                        src="{{ asset('assets/cms/img/chadengle.jpg') }}"
                        alt="..."
                        class="avatar-img rounded-circle"
                        />
                    </div>

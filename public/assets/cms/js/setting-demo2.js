...
function customCheckColor(){
	...
	if (logoHeader !== "white") {
		$('.logo-header .navbar-brand').attr('src', 'http://127.0.0.1:8000/assets/cms/img/kaiadmin/logo_light.svg');
	} else {
		$('.logo-header .navbar-brand').attr('src', 'http://127.0.0.1:8000/assets/cms/img/kaiadmin/logo_dark.svg');
	}
}
